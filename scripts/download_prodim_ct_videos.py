#!/usr/bin/env python3
"""Descarcă videoclipurile Prodim CT de pe YouTube în public/docs/equipment/prodim-ct/videos/."""
...
OUT_DIR = ROOT / "public/docs/equipment/prodim-ct/videos"
...
def main() -> None:
    ...
    for video_id in data["videoIds"]:
        ...
        entries.append(
            {
                "youtubeId": video_id,
                "file": f"/docs/equipment/prodim-ct/videos/{path.name}",
