#!/usr/bin/env python3
"""Descarcă videoclipurile PROLINER TELECOMANDĂ în public/docs/equipment/proliner-remote/videos/."""
...
OUT_DIR = ROOT / "public/docs/equipment/proliner-remote/videos"
...
def main() -> None:
    ...
    for video_id in data["videoIds"]:
        ...
        entries.append(
            {
                "youtubeId": video_id,
                "file": f"/docs/equipment/proliner-remote/videos/{path.name}",
