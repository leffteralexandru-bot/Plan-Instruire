#!/usr/bin/env python3
"""Descarcă videoclipurile Bosch GLL 3-80 în public/docs/equipment/bosch-gll-3-80/videos/."""
...
OUT_DIR = ROOT / "public/docs/equipment/bosch-gll-3-80/videos"
...
def main() -> None:
    ...
    for video_id in data["videoIds"]:
        ...
        entries.append(
            {
                "youtubeId": video_id,
                "file": f"/docs/equipment/bosch-gll-3-80/videos/{path.name}",
