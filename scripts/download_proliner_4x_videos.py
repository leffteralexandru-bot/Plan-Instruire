#!/usr/bin/env python3
"""Descarcă videoclipurile Proliner 4.X în public/docs/equipment/proliner-4x/videos/."""
...
OUT_DIR = ROOT / "public/docs/equipment/proliner-4x/videos"
...
def main() -> None:
    ...
    for video_id in data["videoIds"]:
        ...
        entries.append(
            {
                "youtubeId": video_id,
                "file": f"/docs/equipment/proliner-4x/videos/{path.name}",
