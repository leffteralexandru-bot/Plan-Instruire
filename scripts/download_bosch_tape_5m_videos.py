#!/usr/bin/env python3
"""Descarcă videoclipurile tutorial ruletă în public/docs/equipment/bosch-tape-5m/videos/."""
...
OUT_DIR = ROOT / "public/docs/equipment/bosch-tape-5m/videos"
...
def main() -> None:
    ...
    for video_id in data["videoIds"]:
        ...
        entries.append(
            {
                "youtubeId": video_id,
                "file": f"/docs/equipment/bosch-tape-5m/videos/{path.name}",
