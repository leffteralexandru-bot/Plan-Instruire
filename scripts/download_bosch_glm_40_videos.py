#!/usr/bin/env python3
"""Descarcă videoclipurile Bosch GLM 40 în public/docs/equipment/bosch-glm-40/videos/."""
...
OUT_DIR = ROOT / "public/docs/equipment/bosch-glm-40/videos"
...
def main() -> None:
    ...
    for video_id in data["videoIds"]:
        ...
        entries.append(
            {
                "youtubeId": video_id,
                "file": f"/docs/equipment/bosch-glm-40/videos/{path.name}",
